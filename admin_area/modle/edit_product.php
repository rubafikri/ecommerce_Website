...
if(isset($_POST['update'])){
    ...
    $update_product = "update products set p_cat_id='$product_cat',cat_id='$cat',date=NOW(),product_title='$product_title',product_image='$product_img1',product_keywords='$product_keywords',product_price='$product_price' where product_id='$p_id'";
